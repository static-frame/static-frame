...
class TestUnit(TestCase):
    ...
    def test_quilt_extract_array_b3(self) -> None:
        ...
        a1_id_in_bus = id(q1._bus._values_mutable[0].values)
        ...
        a2_id_in_bus = id(q2._bus._values_mutable[0].values)
    ...
    def test_quilt_iter_array_b3(self) -> None:
        ...
        a2_src_id = id(q2._bus._values_mutable[0]._extract_array(None, 0))
        ...
        a1_src_id = id(q1._bus._values_mutable[0]._extract_array(None, 0))
