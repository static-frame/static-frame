...
to_zip_npz(fp, *, config)     Bus      Exporter Write the complet...
...
relabel_at_depth(mapper, depth_le... IndexHierarchyGO Method Return a new Inde...
rename(name)                         IndexHierarchyGO Method Return a new Inde...
<<U68>                               <<U16>           <<U27> <<U83>
