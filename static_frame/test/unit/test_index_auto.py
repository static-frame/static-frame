...
class TestUnit(TestCase):
    def test_index_auto_factory_a(self) -> None:
        idx1 = IndexAutoFactory.from_optional_constructor(4, default_constructor=Index)
    ...
    def test_index_auto_factory_equals_a(self) -> None:
        idx1 = IndexAutoFactory.from_optional_constructor(
            10_000, default_constructor=Index
        )
        idx2 = IndexAutoFactory.from_optional_constructor(
            10_000, default_constructor=Index
        )
