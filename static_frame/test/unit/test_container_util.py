...
class TestUnit(TestCase):
    ...
    def test_index_many_set_a(self) -> None:
        ...
        post1 = _index_many_to_one((idx0,  idx1), Index, many_to_one_type=ManyToOneType.UNION)
        assert isinstance(post1, Index)
        ...
        post2 = _index_many_to_one((idx1,  idx2), Index, many_to_one_type=ManyToOneType.UNION)
        assert isinstance(post2, Index)
        ...
        post3 = _index_many_to_one((idx1,  idx2), Index, many_to_one_type=ManyToOneType.INTERSECT)
    ...
    def test_index_many_set_b(self) -> None:
        ...
        post1 = _index_many_to_one((idx0,  idx1), IndexGO, many_to_one_type=ManyToOneType.UNION)
        self.assertEqual(post1.__class__, IndexGO)

        post2 = _index_many_to_one((idx1,  idx2), IndexGO, many_to_one_type=ManyToOneType.INTERSECT)
        self.assertEqual(post2.__class__, IndexDateGO)

    def test_index_many_set_c(self) -> None:
        idx1 = IndexDate(('2020-02-01', '2020-02-02'))

        post1 = _index_many_to_one((idx1,), Index, many_to_one_type=ManyToOneType.UNION)
        self.assertEqual(post1.__class__, IndexDate)
        self.assertTrue(idx1.equals(post1))

        # empty iterable returns an empty index
        post2 = _index_many_to_one((), Index, many_to_one_type=ManyToOneType.UNION)
    ...
    def test_index_many_set_d(self) -> None:
        ...
        idx3 = _index_many_to_one((idx1, idx2), Index, many_to_one_type=ManyToOneType.UNION)
    ...
    def test_index_many_set_f(self) -> None:
        idx1 = Index(range(2), loc_is_iloc=True)
        idx2 = Index(range(4), loc_is_iloc=True)
        idx3 = _index_many_to_one((idx1, idx2), Index, many_to_one_type=ManyToOneType.INTERSECT)
        self.assertTrue(idx3._map is None) #type: ignore
    ...
    def test_index_many_set_h(self) -> None:
        post1 = _index_many_to_one((), Index, many_to_one_type=ManyToOneType.UNION, explicit_constructor=IndexDate)
    ...
    def test_index_many_set_i(self) -> None:
        ...
        post = _index_many_to_one((idx1, idx2), Index, many_to_one_type=ManyToOneType.UNION)
        post = tp.cast(IndexHierarchy, post)
    ...
    def test_index_many_set_k(self) -> None:
        ...
        post = _index_many_to_one((idx1, idx2), Index, many_to_one_type=ManyToOneType.INTERSECT)
        post = tp.cast(IndexHierarchy, post)
    ...
    def test_index_many_set_m(self) -> None:
        ...
        idx2 = _index_many_to_one((idx0,  idx1), Index, many_to_one_type=ManyToOneType.DIFFERENCE)
    ...
    def test_index_many_set_n(self) -> None:
        ...
        post1 = _index_many_to_one((idx0,  idx1), Index, many_to_one_type=ManyToOneType.DIFFERENCE)
