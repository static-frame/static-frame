...
class TestUnit(TestCase):
    ...
    def test_interface_summary_b(self) -> None:
        ...
        self.assertEqual(
            counts.to_pairs(),
            (('Accessor Datetime', 10), ('Accessor Fill Value', 24), ('Accessor Regular Expression', 7), ('Accessor String', 36), ('Accessor Transpose', 24), ('Assignment', 8), ('Attribute', 11), ('Constructor', 30), ('Dictionary-Like', 7), ('Display', 6), ('Exporter', 23), ('Iterator', 224), ('Method', 77), ('Operator Binary', 24), ('Operator Unary', 4), ('Selector', 13))
        )
