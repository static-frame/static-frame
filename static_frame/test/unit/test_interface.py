...
class TestUnit(TestCase):
    ...
    def test_interface_summary_b(self) -> None:
        ...
        self.assertEqual(
            counts.to_pairs(),
            (('Accessor Datetime', 8), ('Accessor String', 35), ('Assignment', 4), ('Attribute', 11), ('Constructor', 29), ('Dictionary-Like', 7), ('Display', 6), ('Exporter', 19), ('Iterator', 224), ('Method', 64), ('Operator Binary', 24), ('Operator Unary', 4), ('Selector', 13))
        )
