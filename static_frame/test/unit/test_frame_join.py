...
class TestUnit(TestCase):
    ...
    def test_frame_join_a1(self) -> None:
        ...
        f2 = Frame.from_dict(dict(c=('foo', 'bar'), d=(10, 20)), index=('x', 'y'))

        f3 = f1.join_inner(
            f2, left_depth_level=0, right_depth_level=0, include_index=True
        )
        ...
        self.assertEqual(
            f5.to_pairs(),
            (
                ('a', ((0, 10.0), (1, 10.0), (2, None), ('foo', 20.0), ('x', 20.0))),
                ('b', ((0, 'x'), (1, 'x'), (2, 'y'), ('foo', 'y'), ('x', 'z'))),
                ('c', ((0, None), (1, None), (2, None), ('foo', None), ('x', 'foo'))),
                ('d', ((0, None), (1, None), (2, None), ('foo', None), ('x', 10.0))),
            ),
        )
    ...
    def test_frame_join_a2(self) -> None:
        ...
        f3 = f1.join_inner(
            f2, left_depth_level=0, right_depth_level=0, include_index=False
        )
        self.assertEqual(
            f3.to_pairs(),
            (
    ...
    def test_frame_join_d1(self) -> None:
        ...
        f1 = Frame.from_dict(
            dict(a=tuple(range(10)), b=tuple('pqrstuvwxy')),
            index=index2,
            dtypes=(np.int64, np.str_),
        )
        f2 = Frame.from_dict(
            dict(c=tuple(range(10, 15)), d=tuple('fffgg')),
            index=index1,
            dtypes=(np.int64, np.str_),
        )
        ...
        self.assertEqual(
            ...
            (
                (
                    'a',
                    (
                        ((('A', dt64('2020-05-04')), dt64('2020-05-04')), 0),
                        ((('A', dt64('2020-05-05')), dt64('2020-05-05')), 1),
                        ((('A', dt64('2020-05-06')), dt64('2020-05-06')), 2),
                        ((('A', dt64('2020-05-07')), dt64('2020-05-07')), 3),
                        ((('A', dt64('2020-05-08')), dt64('2020-05-08')), 4),
                        ((('B', dt64('2020-05-04')), dt64('2020-05-04')), 5),
                        ((('B', dt64('2020-05-05')), dt64('2020-05-05')), 6),
                        ((('B', dt64('2020-05-06')), dt64('2020-05-06')), 7),
                        ((('B', dt64('2020-05-07')), dt64('2020-05-07')), 8),
                        ((('B', dt64('2020-05-08')), dt64('2020-05-08')), 9),
                    ),
                ),
                (
                    'b',
                    (
                        ((('A', dt64('2020-05-04')), dt64('2020-05-04')), 'p'),
                        ((('A', dt64('2020-05-05')), dt64('2020-05-05')), 'q'),
                        ((('A', dt64('2020-05-06')), dt64('2020-05-06')), 'r'),
                        ((('A', dt64('2020-05-07')), dt64('2020-05-07')), 's'),
                        ((('A', dt64('2020-05-08')), dt64('2020-05-08')), 't'),
                        ((('B', dt64('2020-05-04')), dt64('2020-05-04')), 'u'),
                        ((('B', dt64('2020-05-05')), dt64('2020-05-05')), 'v'),
                        ((('B', dt64('2020-05-06')), dt64('2020-05-06')), 'w'),
                        ((('B', dt64('2020-05-07')), dt64('2020-05-07')), 'x'),
                        ((('B', dt64('2020-05-08')), dt64('2020-05-08')), 'y'),
                    ),
                ),
                (
                    'c',
                    (
                        ((('A', dt64('2020-05-04')), dt64('2020-05-04')), 10),
                        ((('A', dt64('2020-05-05')), dt64('2020-05-05')), 11),
                        ((('A', dt64('2020-05-06')), dt64('2020-05-06')), 12),
                        ((('A', dt64('2020-05-07')), dt64('2020-05-07')), 13),
                        ((('A', dt64('2020-05-08')), dt64('2020-05-08')), 14),
                        ((('B', dt64('2020-05-04')), dt64('2020-05-04')), 10),
                        ((('B', dt64('2020-05-05')), dt64('2020-05-05')), 11),
                        ((('B', dt64('2020-05-06')), dt64('2020-05-06')), 12),
                        ((('B', dt64('2020-05-07')), dt64('2020-05-07')), 13),
                        ((('B', dt64('2020-05-08')), dt64('2020-05-08')), 14),
                    ),
                ),
                (
                    'd',
                    (
                        ((('A', dt64('2020-05-04')), dt64('2020-05-04')), 'f'),
                        ((('A', dt64('2020-05-05')), dt64('2020-05-05')), 'f'),
                        ((('A', dt64('2020-05-06')), dt64('2020-05-06')), 'f'),
                        ((('A', dt64('2020-05-07')), dt64('2020-05-07')), 'g'),
                        ((('A', dt64('2020-05-08')), dt64('2020-05-08')), 'g'),
                        ((('B', dt64('2020-05-04')), dt64('2020-05-04')), 'f'),
                        ((('B', dt64('2020-05-05')), dt64('2020-05-05')), 'f'),
                        ((('B', dt64('2020-05-06')), dt64('2020-05-06')), 'f'),
                        ((('B', dt64('2020-05-07')), dt64('2020-05-07')), 'g'),
                        ((('B', dt64('2020-05-08')), dt64('2020-05-08')), 'g'),
                    ),
                ),
            ),
        )
    ...
    def test_frame_join_e1(self) -> None:
        ...
        f1 = Frame.from_dict(
            dict(a=tuple(range(10)), b=tuple('pqrstuvwxy')), index=index1
        )
        f2 = Frame.from_dict(dict(c=tuple(range(10, 13)), d=tuple('fgh')), index=index2)
    ...
    def test_frame_join_f1(self) -> None:
        ...
        f2 = Frame.from_dict(
            dict(c=('y', 'y', 'w'), d=(1000, 3000, 2000)), index=('q', 'p', 'r')
        )

        f3 = f1.join_left(
            f2, left_columns='b', right_columns='c', include_index=True, fill_value=None
        )
        self.assertEqual(f3.shape, (7, 4))
    ...
    def test_frame_join_f2(self) -> None:
        ...
        f3 = f1.join_right(
            f2, left_columns='b', right_columns='c', fill_value=None, include_index=True
        )
            ...
            (
                ...
                (
                    ...
                    (
                        ...
                        (('t', 'p'), 'Fruit Salad'),
                        (('t', 'q'), 'Fruit Salad'),
                        (('u', None), 'Weekday Risotto'),
                        (('v', None), 'Beans Chili'),
                        (('w', None), 'Chicken Casserole'),
                    ),
                ),
                (
                    'new_recipe_id',
    ...
    def test_frame_join_h2(self) -> None:
        ...
        self.assertEqual(
            f4.to_pairs(),
            (
                ('c', ((0, None), (1, None), (2, None), (3, None), (4, None))),
                ('d', ((0, None), (1, None), (2, None), (3, None), (4, None))),
                ('a', ((0, 10), (1, 10), (2, 20), (3, 20), (4, 20))),
                ('b', ((0, 'x'), (1, 'x'), (2, 'y'), (3, 'y'), (4, 'z'))),
            ),
        )
    ...
    def test_frame_join_h5(self) -> None:
        ...
        self.assertEqual(
            f3.to_pairs(),
            (
                ('c', ((0, 'foo'), (1, 'foo'), (2, 'bar'), (3, 'bar'), (4, ''))),
                ('d', ((0, 10), (1, 10), (2, 20), (3, 20), (4, 0))),
                ('a', ((0, 10), (1, 10), (2, 20), (3, 20), (4, 20))),
                ('b', ((0, 'x'), (1, 'x'), (2, 'y'), (3, 'y'), (4, 'z'))),
            ),
        )
    ...
    def test_frame_join_i(self) -> None:
        f1 = Frame.from_dict(
            dict(a=(10, 10, 20, 20), b=('x', 'x', 'y', 'z')), index=('a', 'b', 'c', 'd')
        )
        f2 = Frame.from_dict(dict(c=('foo', 'bar'), d=(10, 20)), index=('c', 'd'))
        ...
        self.assertEqual(
            f3.to_pairs(),
            (
                ('a', (('a', 10), ('b', 10), ('c', 20), ('d', 20))),
                ('b', (('a', 'x'), ('b', 'x'), ('c', 'y'), ('d', 'z'))),
                ('c', (('a', None), ('b', None), ('c', 'foo'), ('d', 'bar'))),
                ('d', (('a', None), ('b', None), ('c', 10), ('d', 20))),
            ),
        )
    ...
    def test_frame_join_j(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                ...
                ('d', ((('x', 0), 10), (('x', 1), 10), (('y', 2), 20), (('y', 3), 20))),
                ('a', ((('x', 0), 10), (('x', 1), 10), (('y', 2), 20), (('y', 3), 20))),
                (
                    'b',
                    (
                        (('x', 0), 'x'),
    ...
    def test_frame_join_m1(self) -> None:
        ...
        self.assertEqual(
            f3.to_pairs(),
            (
                ('a1', ((0, '111'), (1, '555'), (2, '000'), (3, '333'), (4, '444'))),
                ('b', ((0, 'R'), (1, 'S'), (2, 'B'), (3, 'C'), (4, 'D'))),
                ('a2', ((0, '111'), (1, '555'), (2, ''), (3, '333'), (4, '444'))),
                ('c', ((0, 1111), (1, 1111), (2, ''), (3, 3333), (4, 4444))),
            ),
        )
    ...
    def test_frame_join_n2(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                ...
                ('b', ((0, 'R'), (1, 'S'), (2, 'B'), (3, 'C'), (4, 'D'), (5, 'X'))),
                (
                    'a2',
                    ((0, '111'), (1, '555'), (2, ''), (3, '333'), (4, '444'), (5, '')),
                ),
                ('c', ((0, 1111), (1, 5555), (2, ''), (3, 3333), (4, 4444), (5, ''))),
            ),
        )
    ...
    def test_frame_join_o1(self) -> None:
        ...
        f3 = f1.join_left(
            f2, left_columns=['a1', 'a2'], right_columns=['a3', 'a4'], fill_value=''
        )
        ...
        self.assertEqual(
            ...
            (
                ...
                (
                    'a2',
                    ((0, 1), (1, 5), (2, 0), (3, 3), (4, 3), (5, 3), (6, 3), (7, 6)),
                ),
                (
                    'b',
                    (
    ...
    def test_frame_merge_c(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                ...
                ('a2', ((0, 1), (1, 5), (2, 3), (3, 3), (4, 3), (5, 3))),
                ('b', ((0, 'R'), (1, 'S'), (2, 'C'), (3, 'C'), (4, 'Q'), (5, 'Q'))),
                ('a4', ((0, 1), (1, 5), (2, 3), (3, 3), (4, 3), (5, 3))),
                (
                    'c',
                    ((0, 1111), (1, 5555), (2, 7777), (3, 3333), (4, 7777), (5, 3333)),
                ),
            ),
        )
