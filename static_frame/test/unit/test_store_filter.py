...
class TestUnit(TestCase):
    def test_store_from_type_filter_array_a(self) -> None:
        ...
        self.assertEqual(
            sfd.from_type_filter_array(a1).tolist(), [1.0, 2.0, '', 'inf', '-inf']
        )

        self.assertEqual(
            sfd.from_type_filter_array(a2).tolist(), [1.0, 2.0, '', 'inf', '-inf']
        )
    ...
    def test_store_from_type_filter_array_b(self) -> None:
        ...
        self.assertEqual(sfd.from_type_filter_array(a1).tolist(), [False, True, False])
        self.assertEqual(sfd.from_type_filter_array(a2).tolist(), [False, True, False])
    ...
    def test_store_from_type_filter_array_c(self) -> None:
        ...
        self.assertEqual(sfd.from_type_filter_array(a1).tolist(), [1, 20, 1])
        self.assertEqual(sfd.from_type_filter_array(a2).tolist(), [1, 20, 1])
    ...
    def test_store_from_type_filter_array_d(self) -> None:
        ...
        self.assertEqual(
            sfd.from_type_filter_array(a1).tolist(), [1, 'None', '', '-inf', 'inf']
        )
    ...
    def test_store_from_type_filter_array_e(self) -> None:
        ...
        self.assertAlmostEqualValues(
            sfd.from_type_filter_array(a1).tolist(), [1, None, np.nan, -np.inf, np.inf]
        )
    ...
    def test_store_from_type_filter_array_g(self) -> None:
        ...
        a2 = sfd.from_type_filter_array(a1)
        self.assertEqual(
            a2.tolist(), [datetime.date(2012, 2, 5), datetime.date(2013, 5, 21), '']
        )
    ...
    def test_store_to_type_filter_array_b(self) -> None:
        ...
        post = sfd.to_type_filter_array(a1)
        self.assertAlmostEqualValues(
            post.tolist(), [datetime.date(2012, 1, 1), datetime.date(2013, 1, 1)]
        )
    ...
    def test_store_filter_to_delimited_a(self) -> None:
        ...
        store_filter = StoreFilter(
            from_nan='*', from_none='!', from_posinf='&', from_neginf='@'
        )
        post = StringIO()
    ...
    def test_store_filter_format_inexact_element_a(self) -> None:
        ...
        self.assertEqual(
            sf1._format_inexact_element(0.000000020, DTYPE_FLOAT_KIND), '2.00e-08'
        )
        self.assertEqual(
            sf1._format_inexact_element(0.000001119, DTYPE_OBJECT_KIND), '1.12e-06'
        )

        self.assertEqual(sf1._format_inexact_element(20, DTYPE_OBJECT_KIND), 20)
    ...
    def test_store_filter_format_inexact_element_b(self) -> None:
        ...
        self.assertEqual(
            sf1._format_inexact_element(0.0000011193, DTYPE_OBJECT_KIND), '1.1193e-06'
        )
        self.assertEqual(sf1._format_inexact_element('foo', DTYPE_OBJECT_KIND), 'foo')
    ...
    def test_store_filter_format_inexact_element_c(self) -> None:
        ...
        self.assertEqual(
            sf1._format_inexact_element(0.83255500, DTYPE_FLOAT_KIND), '0.83255500'
        )
        self.assertEqual(
            sf1._format_inexact_element(0.0000011193, DTYPE_OBJECT_KIND), '0.00000112'
        )
        self.assertEqual(sf1._format_inexact_element(False, DTYPE_OBJECT_KIND), False)
    ...
    def test_store_filter_format_inexact_element_f(self) -> None:
        ...
        self.assertEqual(sf1._format_inexact_element(0.4123, DTYPE_FLOAT_KIND), 0.4123)

    def test_store_filter_format_inexact_element_g(self) -> None:
        sf1 = StoreFilter()

        self.assertEqual(
            sf1._format_inexact_element(0.4123 - 3j, DTYPE_COMPLEX_KIND), 0.4123 - 3j
        )
    ...
    def test_store_filter_format_inexact_array_a(self) -> None:
        ...
        self.assertEqual(
            post1.tolist(), ['0.83255500', '0.00000112', '0.83255500', '20.00000000']
        )
        ...
        self.assertEqual(
            post3.tolist(),
            [
                '0.41300000-0.00000059j',
                '0.41230000-0.59300000j',
                '0.83255500+0.00000000j',
                '20.00000000+3.00000000j',
            ],
        )
        ...
        self.assertEqual(
            post4.tolist(), ['0.83255500', '0.00000112', '0.83255500', '20.00000000']
        )
    ...
    def test_store_filter_format_inexact_array_b(self) -> None:
        ...
        self.assertEqual(
            post1.tolist(), [['8.33e-01', '1.12e-06'], ['8.33e-01', '2.00e+01']]
        )
    ...
    def test_store_filter_format_inexact_array_c(self) -> None:
        ...
        self.assertEqual(post1.tolist(), ['0.833', None, '0.000', '0.833', 20, True])
