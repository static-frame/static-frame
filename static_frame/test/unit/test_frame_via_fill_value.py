...
class TestUnit(TestCase):
    def test_frame_via_fill_value_a1(self) -> None:
        ...
        self.assertEqual(
            f3.to_pairs(),
            (
                ('zUvW', (('zUvW', 30205), ('zZbu', -3648), ('ztsv', 91301))),
                ('zZbu', (('zUvW', 84967), ('zZbu', -176034), ('ztsv', 185734))),
                ('ztsv', (('zUvW', 5729), ('zZbu', 324394), ('ztsv', -82314))),
            ),
        )
        ...
        self.assertEqual(
            f4.to_pairs(),
            (
                ('zUvW', (('zZbu', -3648), ('ztsv', 91301), ('zUvW', 30205))),
                ('zZbu', (('zZbu', -176034), ('ztsv', 4850), ('zUvW', -3050))),
                ('ztsv', (('zZbu', 324394), ('ztsv', 121040), ('zUvW', 167926))),
            ),
        )
    ...
    def test_frame_via_fill_value_a2(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                ('zUvW', (('zUvW', 30205), ('zZbu', -3648), ('ztsv', 91301))),
                ('zZbu', (('zUvW', 0), ('zZbu', 7746992289), ('ztsv', 8624279689))),
                ('ztsv', (('zUvW', 5729), ('zZbu', 26307866809), ('ztsv', 1693898649))),
            ),
        )
    ...
    def test_frame_via_fill_value_b(self) -> None:
        ...
        self.assertEqual(
            f3.to_pairs(),
            (
                ('zZbu', (('zUvW', 84967), ('zZbu', 0), ('ztsv', 185734))),
                ('ztsv', (('zUvW', 5729), ('zZbu', 0), ('ztsv', -82314))),
                ('zUvW', (('zUvW', 30205), ('zZbu', 0), ('ztsv', 182602))),
            ),
        )
    ...
    def test_frame_via_fill_value_loc_a(self) -> None:
        ...
        self.assertEqual(
            f2.to_pairs(), (('w', (('c', -1), ('d', -1))), ('x', (('c', 6), ('d', 9))))
        )
    ...
    def test_frame_via_fill_value_loc_c(self) -> None:
        ...
        self.assertEqual(s1.to_pairs(), (('w', -1), ('y', 4), ('z', 5)))
    ...
    def test_frame_via_fill_value_loc_f(self) -> None:
        ...
        self.assertEqual(
            f2.to_pairs(), (('y', (('b', 4), ('e', -1))), ('q', (('b', -1), ('e', -1))))
        )
    ...
    def test_frame_via_fill_value_loc_l(self) -> None:
        f1 = Frame.from_element('a', index=[1, 2, 3], columns=['a', 'b']).rename(
            index='y', columns='x'
        )
    ...
    def test_frame_via_fill_value_loc_m(self) -> None:
        f1 = Frame.from_element(
            'a', index=[1, 2, 3], columns=IndexYearMonth(['2024-01', '1954-03'])
        ).rename(index='y', columns='x')
        f2 = f1.via_fill_value('').loc[[1, 2], ['1954-03', '3000-01']]
        self.assertEqual(
            f2.to_pairs(),
            (
                (np.datetime64('1954-03'), ((1, 'a'), (2, 'a'))),
                (np.datetime64('3000-01'), ((1, ''), (2, ''))),
            ),
        )

    def test_frame_via_fill_value_loc_n(self) -> None:
        f1 = FrameGO.from_element(
            'a', index=[1, 2, 3], columns=IndexYearMonth(['2024-01', '1954-03'])
        ).rename(index='y', columns='x')
        f2 = f1.via_fill_value('').loc[[1, 2], ['1954-03', '3000-01']]
        self.assertEqual(
    ...
    def test_frame_via_fill_value_loc_o(self) -> None:
        f1 = Frame.from_element(
            0,
            index=IndexHierarchy.from_product(('a', 'b'), (True, False)),
            columns=IndexHierarchy.from_product(('x', 'y'), (True, False)),
        )
        f2 = f1.via_fill_value(-1).loc[
            list(f1.index) + [('c', True)], list(f1.columns) + [('z', False)]
        ]
    ...
    def test_frame_via_fill_value_getitem_a(self) -> None:
        ...
        labels = [label]
        f1 = Frame.from_element(
            0, index=['x'], columns=IndexHierarchy.from_labels(labels)
        )
    ...
    def test_frame_via_fill_value_hloc_a(self) -> None:
        f1 = Frame.from_element(
            1, index=IndexHierarchy.from_labels([[1, 2], [3, 4]]), columns=['a', 'b']
        )
        ...
        self.assertEqual(
            f3.to_pairs(),
            (
                (np.str_('a'), (((np.int64(1), np.int64(2)), np.int64(1)),)),
                (np.str_('b'), (((np.int64(1), np.int64(2)), np.int64(1)),)),
            ),
        )
    ...
    def test_frame_via_fill_value_hloc_b(self) -> None:
        f1 = Frame.from_element(
            1,
            index=IndexHierarchy.from_labels([[1, 2], [3, 4], [10, 20]]),
            columns=['a', 'b'],
        )
