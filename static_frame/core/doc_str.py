...
STORE_CONFIG_MAP = (
    'config: A :obj:`StoreConfigBase`, or a mapping of label to :obj:`StoreConfigBase`'
)
...
class DOC_TEMPLATE:
    ...
    astype = dict(dtype=DTYPE_SPECIFIER)
    ...
    constructor_frame = dict(
        dtypes=DTYPES, name=NAME, consolidate_blocks=CONSOLIDATE_BLOCKS
    )
    delimited = dict(
