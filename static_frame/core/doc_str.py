...
class DOC_TEMPLATE:
    ...
    delimited = dict(
            ...
            include_columns_name='Incldue_columns_name: If including index, populate the column to the left of the columns with the columns ``name``. Cannot be True if ``include_index_name`` is True.',
            ...
            store_filter='store_fitler: A :obj:`StoreFilter` instance.',
            )
    duplicated = dict(
