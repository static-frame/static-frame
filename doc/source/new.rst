...
``Frame.set_index_hierarchy`` now accepts an ``reorder_for_hierarchy`` argument, reordering the selected columns, and reording the rows appropriately, to support hierarchability.
